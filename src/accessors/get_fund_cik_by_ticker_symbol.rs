use std::error::Error;
use crate::models::{InvestmentCompany, Cik};

// TODO: Document
pub fn get_fund_cik_by_ticker_symbol(investment_companies: &[InvestmentCompany], ticker_symbol: &str) -> Result<Cik, Box<dyn Error>> {
